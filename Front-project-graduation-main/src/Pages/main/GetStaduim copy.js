...
//  const isHourReserved = (selectedHour) => {
//     // Check if the selected hour is in the reserved hours array
//     return availableHours.some((day) =>
//       day.hours.some((hour) => DateTime.fromISO(hour.hour).toISO() === selectedHour)
//     );
//   };
...
//             // disabled={isHourReserved(DateTime.fromISO(hour).toISO())}
//             style={{background:"#8d9799",color:"white",padding:"6px",borderRadius:"20px",textAlign:"center",margin:'40rem',width:"20rem"}}
//             // onSubmit={nav('pages/main')}
//         >
